...
For the Cabin Column, we decided to split the Cabin column into CabinDeck, CabinNo. and CabinSide. We then visualized the CabinDeck and CabinSide against the target variable. The results were:
